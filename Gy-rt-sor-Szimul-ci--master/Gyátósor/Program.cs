...
namespace Gyártósor
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            csúnyaTermék.eszközök = egysszerűGép;
            ...
            hasznosTermék.eszközök = csúnyaGép;
            ...
            újrahsznosíthatóTermék.eszközök = hangosGép;
            ...
            while (gyár.fut)
            {
                int b =gyár.MenuÍrás(aktív, A, B, C, gyár, olcsóAlapanyag, drágaAlapanyag, csúnyaAlalpanyag, újrahasznósítottAlapanyag, veszélyesAlapanyag, titokzatosEredetűAlapanyag, hangosGép, egysszerűGép, csúnyaGép);
                aktív = b;
            }
